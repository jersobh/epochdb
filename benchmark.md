# EpochDB v0.6.1 — Benchmark Results
...
> `gemini-embedding-2-preview` (3072D) · v0.6.1 Hardened
...
- **recall@3**: `1.000` (after v0.6.1 engine upgrades)
...
### 6. Quantitative Logic Benchmarks (v0.6.1)
...
## Final v0.6.1 Certification - 2026-05-07

**EpochDB v0.6.1** is the first internal release to deliver a perfect **1.000 sweep** across all named benchmarks while maintaining sub-millisecond relational query speeds.
