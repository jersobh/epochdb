...
import z3
import numpy as np
from epochdb.core.atom import UnifiedMemoryAtom, PayloadType, ScalarPayload, SeriesPayload, ConstraintPayload, SeriesPoint, Interval
from epochdb.core.units import UnitRegistry
from epochdb.retrieval.fork_quant import QuantitativeForkManager
...
class QuantitativeIndexManager:
    ...
    def __init__(self, unit_registry: Optional[UnitRegistry] = None, storage_dir: Optional[str] = None):
        ...
        self.unit_registry = unit_registry or UnitRegistry()
        from epochdb.entities.cascade import CascadeManager
        from epochdb.retrieval.fork_quant import QuantitativeForkManager
